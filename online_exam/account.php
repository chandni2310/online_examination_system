  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?> ><a href="account.php?q=1"><span class="glyphicon glyphicon-check" aria-hidden="true"></span>&nbsp;MCQS<span class="sr-only">(current)</span></a></li>
        <li <?php if(@$_GET['q']==4) echo'class="active"'; ?> ><a href="account.php?q=4"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;True or False</a></li>
...
//result display
if(@$_GET['q']== 'result' && @$_GET['eid'] && @$_GET['qid']) 
{
$eid=@$_GET['eid'];
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/main_bg.jpg" width=100 height=100 alt="Chandni Parikh" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Chandni</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 901067890</h4>
		<h4 style="font-family:'typo' ">cdparikh@gmail.com</h4>
		<h4 style="font-family:'typo' ">CSIT, Charusat University</h4></div></div>
		</p>
      </div>
